...
The microBean™ Invoke project provides classes and interfaces related to functional constructs and the `invokedynamic`
and `ldc` features of the Java language and virtual machine.
...
microBean™ Invoke is available on [Maven Central](https://search.maven.org/).  Include microBean™ Invoke as a Maven
dependency:
